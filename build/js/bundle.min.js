function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("darkMode"):document.body.classList.remove("darkMode"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("darkMode"):document.body.classList.remove("darkMode")}));document.querySelector(".navegacion-dark-mode").addEventListener("click",(function(){document.body.classList.toggle("darkMode"),document.body.classList.contains("darkMode")?document.getElementById("dark-mode-texto").innerText="Modo luz":document.getElementById("dark-mode-texto").innerText="Modo oscuro"}))}function eventListeners(){const e=document.querySelector(".menu-mobile"),n=document.querySelector(".close-menu");e.addEventListener("click",navegacionResponsive),n.addEventListener("click",cerrar)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function cerrar(){document.querySelector(".navegacion").classList.remove("mostrar")}
